...
export default function Complaints() {
  ...
  async function send(e) {
    ...
    try {
      ...
      if (e1) throw e1
      // Notifier les gestionnaires (tout l'immeuble ici, transparence totale)
      await notifyBuilding(building.id, {
        type: 'reclamation_maj', titre: t('complaints.newComplaint') + ' : ' + form.titre,
        message: form.description.slice(0, 120), entiteType: 'reclamation', entiteId: data.id, exclure: uid,
      })
      setShowForm(false)
