          ...
          {dash.mandate ? (
            <div className="space-y-1.5 text-sm">
              <div className="flex justify-between">
                <span className="opacity-60">{t('dashboard.lastVote')}</span>
              ...
              {dash.mandate.syndic?.nom_complet && (
                <div className="flex justify-between">
                  <span className="opacity-60">{t('roles.syndic')}</span>
        ...
        <div className="card">
          ...
          <div className="space-y-1.5 text-sm">
            {dash.lastAG ? (
              <>
                <div className="flex justify-between">
                  <span className="opacity-60">{t('dashboard.lastAG')}</span>
                  <span className="font-medium">{formatDate(dash.lastAG.date_prevue, lang)}</span>
                </div>
                {agDays !== null && (
                  <div className="flex justify-between">
