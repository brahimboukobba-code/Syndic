...
export default function QuoteForm({ projetId, onSaved, onCancel }) {
  const { t } = useTranslation()
  const [form, setForm] = useState({
    intitule: '', prestataire: '', montant: '', delai_estime_jours: '', details: '',
  })
  ...
  async function submit(e) {
    e.preventDefault()
    setError('')
    if (!form.intitule || !form.prestataire || !form.montant) {
