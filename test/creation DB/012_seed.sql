...
-- values ('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'Youssef Syndic', '+212600000000', 'fr')
-- on conflict (id) do nothing;
--
-- insert into public.user_roles (user_id, immeuble_id, role)
-- values ('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', '11111111-1111-1111-1111-111111111111', 'syndic'),
--        ('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', '11111111-1111-1111-1111-111111111111', 'proprietaire');
--
-- insert into public.occupations (logement_id, user_id, type)
-- values ('22222222-0000-0000-0000-000000000001', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'proprietaire');
--
