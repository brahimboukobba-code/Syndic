...
export default function NotificationBell() {
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      {open && (
        <div className="absolute end-0 mt-2 w-80 max-w-[90vw] max-h-[70vh] overflow-y-auto rounded-2xl bg-white dark:bg-brand-700 shadow-xl ring-1 ring-black/10 dark:ring-white/10 z-50">
